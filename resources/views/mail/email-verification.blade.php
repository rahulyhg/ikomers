        ...
        <tbody>
          <tr>
            <td>
                ...
                <p>Selamat bergabung menjadi teman Endless! Kamu telah mendaftarkan email {{$user->email}} sebagai alamat email kamu di Endless Store.</p>
                <p>Ayo verifikasi email kamu untuk mendapatkan update terbaru, berbagai promosi/diskon dan tips-tips menarik dari Endless OS</p>
                
                <br>
                <center><a href="{{url('/verifyemail/'.$user->email_token)}}">VERIFIKASI EMAIL</a></center>
                <br>
