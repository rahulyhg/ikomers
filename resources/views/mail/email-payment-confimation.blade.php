        ...
        <tbody>
          <tr>
            <td>
                ...
                <br>
                <center><a href="{{url('/download-invoice/'.$order->orders_id)}}">DOWNLOAD INVOICE</a></center>
                <br>
                
                <p>Pantau pesanan anda melalui link berikut</p>
                
                <br>
                <center><a href="{{url('track-order')}}">LACAK PESANAN ANDA</a></center>
                <br>

                <p>Terimakasih telah mempercayakan kami sebagai Sistem Operasi Anda.</p>
                <p>Selamat menjelajah ke dalam dunia tanpa batas dengan Sistem Operasi Endless.</p>
